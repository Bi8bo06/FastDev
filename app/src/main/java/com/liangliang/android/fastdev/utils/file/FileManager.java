package com.liangliang.android.fastdev.utils.file;

import android.text.TextUtils;

import com.liangliang.android.core.utils.FileUtils;
import com.liangliang.android.core.utils.StorageUtils;
...
public class FileManager {
    ...
    private static void initPath() {
        ...
        mAppFolderPath = rootPath + "FastDev" + File.separator;// 主文件夹路径
