...
import com.liangliang.android.component.base.application.config.NoDataLayoutConfig;
...
public class NoDataLayout extends LinearLayout {
    ...
    public NoDataLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
