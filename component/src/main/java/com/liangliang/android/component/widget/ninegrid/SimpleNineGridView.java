package com.liangliang.android.component.widget.ninegrid;
        ...
        setListener(new OnNineGridViewListener() {
            ...
            public void onClickPic(String data, int position) {
                PreviewManager
                        ...
                        .setOnClickListener(new com.liangliang.android.component.photopicker.contract.OnClickListener<String>() {
                            @Override
