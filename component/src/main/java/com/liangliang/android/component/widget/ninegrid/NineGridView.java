...
import com.liangliang.android.component.widget.adapter.decoration.GridItemDecoration;
import com.liangliang.android.core.utils.AnimUtils;
import com.liangliang.android.core.utils.ArrayUtils;
import com.liangliang.android.core.utils.VibratorUtils;
    ...
    private ItemTouchHelper.Callback mItemTouchHelperCallback = new ItemTouchHelper.Callback() {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            ...
            if (actionState != ItemTouchHelper.ACTION_STATE_IDLE && isNeedDragVibrate) {
                VibratorUtils.vibrate(getContext(), 100);
            }
